...
/*************************************************************************************************
* Purpose: Default constructor to instantiate mirrored-Z item and set default values
*
* Precondition: instantiate a mirrored-Z item object
*
* Postcondition: mirrored-Z item created, four arrays for rotational states set, inital rotational
